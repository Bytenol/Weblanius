...
export const m4 = {
    ...
    translate: function(m: mat4_t, tx: number, ty: number, tz: number) {
        return m4.multiply(m, m4.translation(tx, ty, tz));
    },

    rotate: function(m: mat4_t, angleInRadians: number) {
        return m4.multiply(m, m4.rotation(angleInRadians));
    },

    scale: function(m: mat4_t, sx: number, sy: number, sz: number) {
    ...
    multiply: function(a: mat4_t, b: mat4_t) {
        var b00 = b[0 * 4 + 0];
        var b01 = b[0 * 4 + 1];
        var b02 = b[0 * 4 + 2];
        var b03 = b[0 * 4 + 3];
