 ...
 */
const createVBO = (gl: WebGLRenderingContext, data: Array<number> | null, length: number = 0, storageType: number | null = null) => {
...
const createEBO = (gl: WebGLRenderingContext, data: Array<number> | null, length: number = 0, storageType: number | null = null) => {
    const type = storageType || gl.STATIC_DRAW;
    const buffer = gl.createBuffer();
